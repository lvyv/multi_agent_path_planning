...
class Animation:
    def __init__(self, map, schedule):
        ...
        self.fig.canvas.set_window_title('网格地图路径规划')
        ...
        self.patches.append(Rectangle((xmin, ymin), xmax - xmin, ymax - ymin, facecolor='none', edgecolor='blue'))
        for o in map["map"]["obstacles"]:
            x, y = o[0], o[1]
            self.patches.append(Rectangle((x - 0.5, y - 0.5), 1, 1, facecolor='grey', fill=False, hatch='///'))
